...
var setGazes = function(cm) {
    ...
    for(var id in gazes) {
      ...
      gazes[id]['selectedLine'] == gazes[myUserId]['selectedLine'] &&
        ...
        if(window.gazeSharing) {
          if(top <= scroll.getBoundingClientRect().top){
            if(scroll.scrollY !== 0){
              ...
              upInd.style.background = `linear-gradient(${hex2rgb(color, 0.5)}, ${hex2rgb(color, 0.0)})`;
            }else{
              upInd.style.background = "none"
              downInd.style.background = "none"
              divc.style.backgroundColor = hex2rgb(color, 0.2);
              divc.style.top = scroll.getBoundingClientRect().top + "px";
            ...
            downInd.style.background = "none"
            divc.style.backgroundColor = hex2rgb(color, 0.0);
            downInd.style.background = `linear-gradient(${hex2rgb(color, 0.0)}, ${hex2rgb(color, 0.5)})`;
          }else{
            upInd.style.background = "none"
            downInd.style.background = "none"
            divc.style.backgroundColor = hex2rgb(color, 0.2);
...
var moveToGaze = function(id) {
  ...
  if(toScroll < window.innerHeight){
    toScroll = window.innerHeight;
  }
  scroll.style.transition = "all 0.1s";
  scroll.scrollTo(0, toScroll - window.innerHeight);
