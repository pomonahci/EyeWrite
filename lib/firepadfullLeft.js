    ...
    for(var id in gazes) {
      ...
      if(line !== undefined && id !== myUserId) { //&& id !== myUserId
        ...
        if(top <= scroll.getBoundingClientRect().top){
          if(scroll.scrollY !== 0){
            divc.style.backgroundColor = hex2rgb(color, 0.0);
            ...
            downInd.style.left = offsets.left - 7 + "px";
            upInd.style.left = offsets.left - 7 + "px";
          }else{
            divc.style.backgroundColor = hex2rgb(color, 1.0);
            divc.style.top = top + "px";
            divc.style.left = offsets.left - 7 + "px";
...
firepad.FirebaseAdapter = (function (global) {
  ...
  FirebaseAdapter.prototype.monitorGaze_ = function() {
    ...
    function childAdded(childSnap) {
      ...
      upInd.style.left = left - 7 + "px";
      upInd.id = clientId + "up";
      upInd.style.zIndex = 10;
      upInd.style.width = "10px";
      ...
      downInd.style.left = left - 7 + "px";
      downInd.id = clientId + "down";
      downInd.style.zIndex = 10;
      downInd.style.width = "10px";
